...
/** 열람 권한 판정에 필요한 부서 + 상위 부문장 */
type DeptWithDivision = Pick<Department, 'id' | 'head_user_id' | 'division_id'> & {
...
export default function DepartmentDetailPage() {
  ...
  useEffect(() => {
    const checkAccess = async () => {
      ...
      if (dept.divisions?.head_user_id === user.id) {
        setAuthorized(true)
        return
      }
