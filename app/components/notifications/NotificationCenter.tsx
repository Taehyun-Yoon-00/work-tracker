  ...
  return (
    <>
      ...
      <div className="absolute right-2 top-full mt-2 w-80 max-w-[90vw] max-h-[70vh] overflow-y-auto bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-xl shadow-lg z-50">
        ...
        {loading && (
          <p className="px-4 py-8 text-center text-xs text-gray-400">불러오는 중…</p>
        )}
            ...
            >
              ...
              <span className="flex-1 min-w-0">
                <span className="flex items-center gap-1.5">
                  <span className={`text-sm truncate ${n.is_read ? 'text-gray-700 dark:text-zinc-200' : 'font-semibold text-gray-900 dark:text-white'}`}>
                    {n.title}
                  </span>
