...
export default function NotificationCenter({
  ...
  return (
    <>
      ...
      <div className="absolute right-4 top-full mt-2 w-80 max-w-[90vw] max-h-[70vh] overflow-y-auto bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-lg shadow-lg z-50">
