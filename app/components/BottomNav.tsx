...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-16 bg-white dark:bg-zinc-800 border-t border-gray-200 dark:border-zinc-700 z-50">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex-1 h-full pt-2 flex flex-col items-center justify-start gap-0.5 transition relative ${
                isActive
                  ? 'text-blue-500'
